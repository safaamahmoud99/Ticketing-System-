   ...
   public interface IRequestRepository 
    {
        ...
        int CountDoneProjects(int projectId);
        int CountWaitingApproveProjects(int projectId);
        int CountApproveProjects(int projectId);
        int CountSystemClosedProjects(int projectId);
        int CountRejectProjects(int projectId);
