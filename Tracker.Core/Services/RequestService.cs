...
namespace Tracker.Core.Services
{
    public class RequestService : IRequestService
    {
        ...
        {
            return _unitOfWork.Request.CountApproveProjects(projectId);
        }
        ...
        {
            return _unitOfWork.Request.CountDoneProjects(projectId);
        }
        ...
        {
            return _unitOfWork.Request.CountRejectProjects(projectId);
        }

        public int CountSystemClosedProjects(int projectId)
        {
            return _unitOfWork.Request.CountSystemClosedProjects(projectId);
        }

        public int CountWaitingApproveProjects(int projectId)
        {
            return _unitOfWork.Request.CountWaitingApproveProjects(projectId);
        }
