...
namespace Tracker.API.Controllers
{
    ...
    public class AuthenticateController : ControllerBase
    {
        ...
        public async Task<IActionResult> Register([FromBody] UserVM model)
        {
            ...
            string url = "http://41.33.73.195/#/login";
            // string url =  "";
            ...
            string from = "almostakbaltechnology.info@gmail.com";
            //  string to = "safaa97mahmoud@gmail.com";
            string subject = "Confirmation Email";
            string body = $"Dear {model.name}\r\n Hope this email finds you well \r\n This is Al-Mostakbal Technology. As per your registration ," +
                $" please note that your Email : {model.Email} And Password :{model.Password} follow link to login {url}";
            string appSpecificPassword = "iwmjmhzxuilrkuxn";

            //  var mailMessage2 = new MailMessage(from, to, subject, body);
            var mailMessage = new MailMessage(from, model.Email, subject, body);
            ...
            var SMSobj = new SMS();
            SMSobj.Language = 1;
            SMSobj.Mobile ="01204107735";
            SMSobj.Message = $"Welcome Shahba to  Almostakbal Technology , As per your registration in Tracker System " +
                $" please note that your Email: sh.torky@gmail.com  And Password : {model.Password} , Follow link to login {url}";
