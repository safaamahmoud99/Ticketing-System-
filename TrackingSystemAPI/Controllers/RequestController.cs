...
namespace Tracker.API.Controllers
{
    ...
    public class RequestController : ControllerBase
    {
        ...
        [Route("CountDoneProjects/{ProjectId}")]
        public int CountDoneProjects(int ProjectId)
        {
            return _requestService.CountDoneProjects(ProjectId);
        }
        [Route("CountWaitingApproveProjects/{ProjectId}")]
        public int CountWaitingApproveProjects(int ProjectId)
        {
            return _requestService.CountWaitingApproveProjects(ProjectId);
        }
        [Route("CountApproveProjects/{ProjectId}")]
        public int CountApproveProjects(int ProjectId)
        {
            return _requestService.CountApproveProjects(ProjectId);
        }
        [Route("CountRejectProjects/{ProjectId}")]
        public int CountRejectProjects(int ProjectId)
        {
            return _requestService.CountRejectProjects(ProjectId);
        }
        [Route("CountSystemClosedProjects/{ProjectId}")]
        public int CountSystemClosedProjects(int ProjectId)
        {
            return _requestService.CountSystemClosedProjects(ProjectId);
        }
    }
}
